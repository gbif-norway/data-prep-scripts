...
class TestSplitRows(unittest.TestCase):
    def test_it_splits_simple_file_names_and_dates(self):
        eg = 'IM1032 (120807); IM1231 (110907)'
        expected = [{'occurrenceid': 'id1', 'file_name': '1032', 'date': '120807'}, {'occurrenceid': 'id1', 'file_name': '1231', 'date': '110907'}]
    ...
    def test_it_does_not_create_rows_for_incorrect_formats_when_mixed_with_valid_1(self):
        ...
        self.assertEqual(split_rows(eg, 'id1'), [{'occurrenceid': 'id1', 'file_name': '3643', 'date': '130708'}])
    ...
    def test_it_does_not_create_rows_for_incorrect_formats_when_mixed_with_valid_3(self):
        eg = 'P3643 (130708); E560 (PBS - Early 90s?); P3643 (130708); SA501 (Sept. 98)'
        self.assertEqual(split_rows(eg, 'id1'), [{'occurrenceid': 'id1', 'file_name': '3643', 'date': '130708'}, {'occurrenceid': 'id1', 'file_name': '3643', 'date': '130708'}])

    def test_it_does_not_break_with_non_date_numbers_in_brackets(self):
        eg = 'P6017 (Self-Seeded on this bed 08; 240808);'
        self.assertEqual(split_rows(eg, 'id1'), [{'occurrenceid': 'id1', 'file_name': '6017', 'date': '240808'}])
    ...
    def test_file_name_ranges(self):
        ...
        expected = [
                {'occurrenceid': 'id1', 'file_name': '5850', 'date': '240906'},
                {'occurrenceid': 'id1', 'file_name': '5851', 'date': '240906'},
                {'occurrenceid': 'id1', 'file_name': '5852', 'date': '240906'},
                {'occurrenceid': 'id1', 'file_name': '5853', 'date': '240906'},
                {'occurrenceid': 'id1', 'file_name': '5854', 'date': '240906'},
                {'occurrenceid': 'id1', 'file_name': '33976', 'date': '290612'},
                {'occurrenceid': 'id1', 'file_name': '33977', 'date': '290612'},
                ]
        self.assertEqual(split_rows(eg, 'id1'), expected)
    ...
    def test_file_name_ranges_mixed_with_file_names_and_incorrect_formats(self):
        ...
        expected = [
                ...
                {'occurrenceid': 'id1', 'file_name': '33976', 'date': '290612'},
                {'occurrenceid': 'id1', 'file_name': '33977', 'date': '290612'},
                {'occurrenceid': 'id1', 'file_name': '3643', 'date': '130708'},
                {'occurrenceid': 'id1', 'file_name': '3099', 'date': '151009'},
                ]
        self.assertEqual(split_rows(eg, 'id1'), expected)
