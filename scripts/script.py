...
matches_on_sn = matched_records[['original_occ_id', 'new_occ_id']]

# If you want to create a new DataFrame with only the specified columns
new_df = matched_records[['original_occ_id', 'new_occ_id']]
...
no_match = no_match.loc[:, ['collectionCode_old', 'catalogNumber_old', 'scientificName', 'recordedBy_old', 'source']]
...
matches_on_ccode = matches_on_ccode_[['original_occ_id', 'new_occ_id']]
...
matches_on_name = matches_on_name_[['original_occ_id', 'new_occ_id']]
